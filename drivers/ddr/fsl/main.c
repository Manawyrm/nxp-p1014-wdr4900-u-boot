...
phys_size_t __fsl_ddr_sdram(fsl_ddr_info_t *pinfo)
{
	...
	debug("FF702000 DDR_CS0_BNDS = %08lx\n", 				_MMIO_LONG(0xFF702000));
	debug("FF702008 DDR_CS1_BNDS = %08lx\n", 				_MMIO_LONG(0xFF702008));
	debug("FF702010 DDR_CS2_BNDS = %08lx\n", 				_MMIO_LONG(0xFF702010));
	debug("FF702018 DDR_CS3_BNDS = %08lx\n", 				_MMIO_LONG(0xFF702018));
	debug("FF702080 DDR_CS0_CONFIG = %08lx\n", 				_MMIO_LONG(0xFF702080));
	debug("FF702084 DDR_CS1_CONFIG = %08lx\n", 				_MMIO_LONG(0xFF702084));
	debug("FF702088 DDR_CS2_CONFIG = %08lx\n", 				_MMIO_LONG(0xFF702088));
	debug("FF70208C DDR_CS3_CONFIG = %08lx\n", 				_MMIO_LONG(0xFF70208C));
	debug("FF7020C0 DDR_CS0_CONFIG_2 = %08lx\n", 			_MMIO_LONG(0xFF7020C0));
	debug("FF7020C4 DDR_CS1_CONFIG_2 = %08lx\n", 			_MMIO_LONG(0xFF7020C4));
	debug("FF7020C8 DDR_CS2_CONFIG_2 = %08lx\n", 			_MMIO_LONG(0xFF7020C8));
	debug("FF7020CC DDR_CS3_CONFIG_2 = %08lx\n", 			_MMIO_LONG(0xFF7020CC));
	debug("FF702100 DDR_TIMING_CFG_3 = %08lx\n", 			_MMIO_LONG(0xFF702100));
	debug("FF702104 DDR_TIMING_CFG_0 = %08lx\n", 			_MMIO_LONG(0xFF702104));
	debug("FF702108 DDR_TIMING_CFG_1 = %08lx\n", 			_MMIO_LONG(0xFF702108));
	debug("FF70210C DDR_TIMING_CFG_2 = %08lx\n", 			_MMIO_LONG(0xFF70210C));
	debug("FF702110 DDR_DDR_SDRAM_CFG = %08lx\n", 			_MMIO_LONG(0xFF702110));
	debug("FF702114 DDR_DDR_SDRAM_CFG_2 = %08lx\n", 		_MMIO_LONG(0xFF702114));
	debug("FF702118 DDR_DDR_SDRAM_MODE = %08lx\n", 			_MMIO_LONG(0xFF702118));
	debug("FF70211C DDR_DDR_SDRAM_MODE_2 = %08lx\n", 		_MMIO_LONG(0xFF70211C));
	debug("FF702120 DDR_DDR_SDRAM_MD_CNTL = %08lx\n", 		_MMIO_LONG(0xFF702120));
	debug("FF702124 DDR_DDR_SDRAM_INTERVAL = %08lx\n", 		_MMIO_LONG(0xFF702124));
	debug("FF702128 DDR_DDR_DATA_INIT = %08lx\n", 			_MMIO_LONG(0xFF702128));
	debug("FF702130 DDR_DDR_SDRAM_CLK_CNTL = %08lx\n", 		_MMIO_LONG(0xFF702130));
	debug("FF702148 DDR_DDR_INIT_ADDR = %08lx\n", 			_MMIO_LONG(0xFF702148));
	debug("FF70214C DDR_DDR_INIT_EXT_ADDR = %08lx\n", 		_MMIO_LONG(0xFF70214C));
	debug("FF702160 DDR_TIMING_CFG_4 = %08lx\n", 			_MMIO_LONG(0xFF702160));
	debug("FF702164 DDR_TIMING_CFG_5 = %08lx\n", 			_MMIO_LONG(0xFF702164));
	debug("FF702170 DDR_DDR_ZQ_CNTL = %08lx\n", 			_MMIO_LONG(0xFF702170));
	debug("FF702174 DDR_DDR_WRLVL_CNTL = %08lx\n", 			_MMIO_LONG(0xFF702174));
	debug("FF70217C DDR_DDR_SR_CNTR = %08lx\n", 			_MMIO_LONG(0xFF70217C));
	debug("FF702180 DDR_DDR_SDRAM_RCW_1 = %08lx\n", 		_MMIO_LONG(0xFF702180));
	debug("FF702184 DDR_DDR_SDRAM_RCW_2 = %08lx\n", 		_MMIO_LONG(0xFF702184));
	debug("FF702190 DDR_DDR_WRLVL_CNTL_2 = %08lx\n", 		_MMIO_LONG(0xFF702190));
	debug("FF702194 DDR_DDR_WRLVL_CNTL_3 = %08lx\n", 		_MMIO_LONG(0xFF702194));
	debug("FF702200 DDR_DDR_SDRAM_MODE_3 = %08lx\n", 		_MMIO_LONG(0xFF702200));
	debug("FF702204 DDR_DDR_SDRAM_MODE_4 = %08lx\n", 		_MMIO_LONG(0xFF702204));
	debug("FF702208 DDR_DDR_SDRAM_MODE_5 = %08lx\n", 		_MMIO_LONG(0xFF702208));
	debug("FF70220C DDR_DDR_SDRAM_MODE_6 = %08lx\n", 		_MMIO_LONG(0xFF70220C));
	debug("FF702210 DDR_DDR_SDRAM_MODE_7 = %08lx\n", 		_MMIO_LONG(0xFF702210));
	debug("FF702214 DDR_DDR_SDRAM_MODE_8 = %08lx\n", 		_MMIO_LONG(0xFF702214));
	debug("FF702B20 DDR_DDRDSR_1 = %08lx\n", 				_MMIO_LONG(0xFF702B20));
	debug("FF702B24 DDR_DDRDSR_2 = %08lx\n", 				_MMIO_LONG(0xFF702B24));
	debug("FF702B28 DDR_DDRCDR_1 = %08lx\n", 				_MMIO_LONG(0xFF702B28));
	debug("FF702B2C DDR_DDRCDR_2 = %08lx\n", 				_MMIO_LONG(0xFF702B2C));
	debug("FF702BF8 DDR_DDR_IP_REV1 = %08lx\n", 			_MMIO_LONG(0xFF702BF8));
	debug("FF702BFC DDR_DDR_IP_REV2 = %08lx\n", 			_MMIO_LONG(0xFF702BFC));
